...
bwt = b0 + b1 * babysex+b2 * bhead+b3 * blength+b4 * fincome+b5 * gaweeks+b6 * mrace + b7 * log(ppbmi)+b8 * wtgain
...
Comment: From the plot, we can see that, the distribution of the r.square is not exactly normal distributed and is slightly left-skewed. This indicate that some of the assumption of the linear regression may violated (e.g. normal distribution of the estimators)
...
Comment: From the plot, again, we can see that, the distribution of the the log term is not exactly normal distributed and is slightly left-skewed. This indicate that some of the assumption of the linear regression may violated (e.g. normal distribution of the estimators)
